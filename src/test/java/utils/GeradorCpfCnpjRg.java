...
public class GeradorCpfCnpjRg {
    ...
    public String cnpj(boolean withDots) {
        int n = 9;
        int n1 = randomize(n);
        int n2 = randomize(n);
        int n3 = randomize(n);
        ...
        int n7 = randomize(n);
        int n8 = randomize(n);
        int n9 = 0; //randomize(n);
        int n10 = 0; //randomize(n);
        int n11 = 0; //randomize(n);
        int n12 = 1; //randomize(n);
    ...
    public String rg(boolean withDots) {
